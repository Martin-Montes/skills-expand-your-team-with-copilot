...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level (e.g., 'Beginner', 'Intermediate', 'Advanced', 'not_specified')
    """
    ...
    if difficulty:
        if difficulty == "not_specified":
            # "not_specified" means activities with no difficulty specified
